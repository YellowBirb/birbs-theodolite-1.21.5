...
import yellowbirb.birbstheodolite.render.shader.Shader;
...
public class WorldBuffer {
    ...
    public WorldBuffer(int drawMode, Shader shader, WorldRenderContext worldRenderContext) {
        ...
        this.shader = shader;
        makeProjectionMatrix(worldRenderContext.projectionMatrix(), worldRenderContext.positionMatrix()); // matrixStack().peek().getPositionMatrix()
